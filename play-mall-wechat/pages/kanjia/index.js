...
Page({
  ...
  getVideoSrc: function (videoId) {
    var that = this;
    wx.request({
      url: app.globalData.domain + '/media/video/detail',
      data: {
        videoId: videoId
      },
      success: function (res) {
  ...
  getKanjiaInfo: function (kjid, joiner) {
    var that = this;
    wx.request({
      url: app.globalData.domain + '/shop/goods/kanjia/info',
      data: {
        kjid: kjid,
        joiner: joiner,
      },
  ...
  getKanjiaInfoMyHelp: function (kjid, joiner) {
    var that = this;
    wx.request({
      url: app.globalData.domain + '/shop/goods/kanjia/myHelp',
      data: {
        kjid: kjid,
        joinerUser: joiner,
  ...
  helpKanjia: function () {
    var that = this;
    wx.request({
      url: app.globalData.domain + '/shop/goods/kanjia/help',
      data: {
        kjid: that.data.kjId,
